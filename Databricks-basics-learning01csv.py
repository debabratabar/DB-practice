...
file_df= spark.read.csv(filepath  , header="true" , inferSchema = "true")
...
# MAGIC create temporary view temp_email_data
# MAGIC using csv 
# MAGIC options(
...
# MAGIC create table if not exists email_data_using_sql
# MAGIC As
